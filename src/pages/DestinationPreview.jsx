...
// Pricing table removed — this is a briefing-only portal
...
<iframe
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
          ...
          {/* Hotel/Package info removed — briefing portal only */}
      ...
      {/* Highlights section removed — shown in ThingsToDoSection */}
      ...
      <div className="py-12 px-4 border-t transition-colors duration-300" style={{ backgroundColor: bgAlt, borderColor: border }}>
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            onClick={() => navigate(-1)}
            className="inline-flex items-center gap-2 font-body font-semibold text-sm px-6 py-3 rounded-full border transition-all duration-200 hover:opacity-80"
