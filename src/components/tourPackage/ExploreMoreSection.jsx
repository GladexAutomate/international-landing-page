  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-5">
        ...
        <h2 className="text-xl font-black font-condensed tracking-wide text-gray-900">Explore More on Gladex</h2>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {destinations.map((dest, i) => (
          <div
            ...
            className="rounded-xl overflow-hidden border border-gray-100 cursor-pointer group hover:shadow-md transition-all"
          >
            ...
            <div className="p-2 bg-white">
              ...
              <p className="text-[10px] font-semibold text-gray-500 mt-0.5">View Guide →</p>
            </div>
          </div>
        ))}
      </div>
