...
export default function NeedAssistance({ contacts, theme }) {
  ...
  const { whatsapp, hotline } = contacts || {};
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {whatsapp && (
          <a
            ...
            style={{
              backgroundColor: isDark ? "#00180E" : "#E6FFF2",
          ...
          >
            ...
            <span className="text-xs font-normal opacity-70" style={{ color: textSecondary }}>
              {whatsapp.subtext}
            </span>
          </a>
        )}
        ...
        {hotline && (
          ...
          >
            ...
            <span className="text-xs font-normal" style={{ color: textSecondary }}>
              {hotline.number}
            </span>
          </a>
        )}
      ...
      <p className="font-body text-xs text-center opacity-60" style={{ color: textSecondary }}>
        Response time may vary. For urgent travel emergencies, call our hotline directly.
      </p>
    </div>
  );
}
