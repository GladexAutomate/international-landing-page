...
export default function NeedAssistance({ contacts, theme }) {
  ...
  const { messenger, whatsapp, hotline } = contacts || {};
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        {messenger && (
          <a
            ...
            style={{
              backgroundColor: isDark ? "#001A3A" : "#E8F4FF",
              borderColor: FB_BLUE,
              color: FB_BLUE,
            }}
          >
        ...
        {whatsapp && (
          ...
          >
            {/* WhatsApp icon using SVG for brand accuracy */}
      ...
      {/* Availability note */}
      <p
        className="font-body text-xs text-center opacity-60"
        style={{ color: textSecondary }}
      >
