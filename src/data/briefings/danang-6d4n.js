/**
 * Da Nang Vietnam — 6D4N Package Briefing Data
 * Package: 6D4N Da Nang 2026 — via Vietjet Air
 *
 * This file is the single source of truth for the 6D4N Da Nang briefing page.
 */

export const danang6d4nBriefing = {

  // ─── 1. WELCOME MESSAGE ──────────────────────────────────────────────────
  welcomeMessage: {
    title: "Official Da Nang Briefing",
    subtitle: "6D4N Da Nang, Vietnam — 2026",
  ...
  travelInformation: {
    beforeDeparture: [
      ...
      "Prepare approximately USD 300 for personal expenses, optional purchases, and leisure spending during the 6-day trip.",
  ...
  groupDeparturePolicy: {
    ...
    penalties: [
      ...
      {
        label: "Days 2–5 — During the Tour",
        amount: "USD 100 per person / per day",
        description: "Any passenger who leaves the group without permission on any tour day in Da Nang.",
      },
    ],
    notes: [
  ...
  whatToBring: [
    ...
    { icon: "👕", label: "Light, breathable clothing (5–6 sets for 6 days)" },
  ...
  outfitGuide: [
    ...
    {
      occasion: "Da Nang City Tours (Days 3 & 4)",
      icon: "🌆",
      tips: [
        "Light and breathable clothing — city tours are mostly outdoors in heat.",
        "Comfortable walking shoes.",
        "Bring a small bag for shopping stops (latex shop, jewelry boutique, silk shop).",
        "Hat or cap for sun protection during outdoor stops.",
      ],
    },
    {
      occasion: "Hai Van Pass & Lang Co Beach (Day 5)",
      icon: "🌊",
      tips: [
  ...
  currencyGuide: {
    ...
    recommendedCash: "Prepare approximately USD 300 for personal expenses, souvenir shopping, leisure spending, and optional purchases during the 6-day trip.",
    whereToExchange: [
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Always inform your guide in advance if you wish to explore independently, ensure you have the guide's contact number, and return to the meeting point or hotel on time. Do not arrange private transportation through unofficial channels.",
    },
    {
      q: "What currency should I use in Da Nang?",
      a: "Vietnamese Dong (VND) is the official currency. USD is also widely accepted in tourist areas, hotels, and restaurants. Exchange money at the airport upon arrival, authorized banks (Vietcombank, Techcombank), or reputable money changers. Never exchange with street vendors. Prepare approximately USD 300 for personal expenses during the 6-day trip.",
    },
    {
      q: "Is tipping expected in Vietnam?",
      a: "Tipping fee for your tour guide and driver is already included in the 6D4N package — you do not need to tip them separately. For restaurants, hotels, or any additional personal services you arrange on your own, small tips are appreciated but entirely optional.",
    },
    {
    ...
    {
      q: "What is included in the 6D4N Da Nang package?",
