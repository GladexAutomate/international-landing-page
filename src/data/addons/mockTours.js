  ...
  "japan": [
    {
      ...
      currency: "JPY",
      bookingOptions: [
        opt("adult", "Adult", 14332, { cancellationPolicy: NON_REFUNDABLE }),
      ],
    ...
    {
      id: "globaltix-48175",
      name: "Airalo Japan eSIM Package",
      source: "globaltix",
      sourceId: "48175",
      sourceProductCode: "48175",
      sourceCategoryId: "wifi-sim-card",
      description: "Stay connected throughout Japan with the Airalo eSIM — fast 4G/5G data, no physical SIM needed. Activate instantly before or upon arrival in Japan.",
      ...
      durationMinutes: 0,
      meetingPoint: "Digital Delivery (eSIM QR Code)",
      category: "WiFi & SIM Card",
      tags: ["esim", "connectivity", "data", "sim"],
      price: 4.5,
      currency: "USD",
      bookingOptions: [
        opt("esim", "eSIM Plan", 4.5, { cancellationPolicy: NON_REFUNDABLE }),
      ],
      inclusions: ["Japan 4G/5G data coverage", "Instant digital delivery", "No physical SIM needed"],
    ...
    },
    {
      ...
      duration: "1–2 Hours",
      durationMinutes: 90,
      meetingPoint: "Abeno Harukas, Osaka (Floor 58–60)",
      category: "Attraction",
      tags: ["osaka", "skyview", "observation deck", "tallest building"],
      price: 1800,
      currency: "JPY",
      bookingOptions: [
        opt("adult", "Adult (18+)", 2000, { ageFrom: 18, cancellationPolicy: NON_REFUNDABLE }),
        opt("teen",  "Junior (12–17)", 1500, { ageFrom: 12, ageTo: 17, cancellationPolicy: NON_REFUNDABLE }),
        opt("child", "Child (6–11)", 500, { ageFrom: 6, ageTo: 11, cancellationPolicy: NON_REFUNDABLE }),
      ],
    ...
    },
    {
      ...
      duration: "1 Hour",
      durationMinutes: 60,
      meetingPoint: "Okayama Castle, Okayama City",
      category: "Attraction",
      tags: ["castle", "history", "okayama", "samurai"],
      price: 400,
      currency: "JPY",
      bookingOptions: [
        opt("adult", "Adult (16+)", 400, { ageFrom: 16, cancellationPolicy: NON_REFUNDABLE }),
        opt("child", "Child (15 & under)", 0, { ageTo: 15, cancellationPolicy: NON_REFUNDABLE }),
      ],
    ...
    },
    {
      ...
      meetingPoint: "Any JR Station in the San'in / Okayama region",
      category: "Rail Pass",
      tags: ["rail pass", "jr", "western japan", "hiroshima", "unlimited"],
      price: 2290,
      currency: "JPY",
      bookingOptions: [
        opt("adult", "Adult", 2290, { cancellationPolicy: NON_REFUNDABLE }),
        opt("child", "Child (6–11)", 1140, { ageFrom: 6, ageTo: 11, cancellationPolicy: NON_REFUNDABLE }),
      ],
      inclusions: ["Unlimited JR rail travel (4 days)", "Covers San'in & Okayama regions", "Reserved seat bookings available"],
      exclusions: ["Nozomi/Mizuho bullet train extra fee", "Meals", "Hotel transfer"],
      requiresBookingDate: true,
      availability: [],
      minParticipants: 1,
      isCancellable: false,
    ...
    },
    {
      ...
      meetingPoint: "Any JR Station in Western Japan (Osaka, Kyoto, Hiroshima, etc.)",
      category: "Rail Pass",
      tags: ["rail pass", "jr", "shinkansen", "western japan", "7 days"],
      price: 10000,
      currency: "JPY",
      bookingOptions: [
        opt("adult", "Adult", 10000, { cancellationPolicy: NON_REFUNDABLE }),
        opt("child", "Child (6–11)", 5000, { ageFrom: 6, ageTo: 11, cancellationPolicy: NON_REFUNDABLE }),
      ],
      inclusions: ["Unlimited JR Shinkansen & local trains (7 days)", "Sanyo & Sanin regions covered", "Hiroshima & Peace Park access"],
      exclusions: ["Nozomi/Mizuho extra surcharge", "Non-JR private railways", "Meals"],
      requiresBookingDate: true,
      availability: [],
      minParticipants: 1,
      isCancellable: false,
